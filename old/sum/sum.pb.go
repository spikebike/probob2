...
type ByteArrays struct {
	...
	Arrays [][]byte `protobuf:"bytes,1,rep,name=arrays,proto3" json:"arrays,omitempty"`
}

func (x *ByteArrays) Reset() {
	*x = ByteArrays{}
...
func (x *ByteArrays) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ByteArrays) ProtoMessage() {}

func (x *ByteArrays) ProtoReflect() protoreflect.Message {
	mi := &file_sum_proto_msgTypes[0]
...
// Deprecated: Use ByteArrays.ProtoReflect.Descriptor instead.
func (*ByteArrays) Descriptor() ([]byte, []int) {
	return file_sum_proto_rawDescGZIP(), []int{0}
}

func (x *ByteArrays) GetArrays() [][]byte {
	if x != nil {
		return x.Arrays
	}
	return nil
...
var file_sum_proto_rawDesc = []byte{
	0x0a, 0x09, 0x73, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x24, 0x0a, 0x0a, 0x42,
	0x79, 0x74, 0x65, 0x41, 0x72, 0x72, 0x61, 0x79, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x72, 0x72,
	0x61, 0x79, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x06, 0x61, 0x72, 0x72, 0x61, 0x79,
	0x73, 0x42, 0x22, 0x5a, 0x20, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x73, 0x70, 0x69, 0x6b, 0x65, 0x62, 0x69, 0x6b, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x62, 0x6f, 0x62,
	0x32, 0x2f, 0x73, 0x75, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_sum_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sum_proto_goTypes = []interface{}{
	(*ByteArrays)(nil), // 0: ByteArrays
}
